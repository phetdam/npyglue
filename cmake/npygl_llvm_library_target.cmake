...
#
# The created INTERFACE imported target will be npygl::llvm_<component>. It is
# assumed that LLVM was found with find_package.
#
# Arguments:
...
function(npygl_llvm_library_target component)
    ...
    add_library(npygl::llvm_${component} INTERFACE IMPORTED)
    target_include_directories(
        npygl::llvm_${component}
        SYSTEM INTERFACE ${LLVM_INCLUDE_DIRS}
    )
    target_link_libraries(npygl::llvm_${component} INTERFACE ${libname})
endfunction()
