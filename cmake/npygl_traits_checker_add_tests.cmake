...
function(npygl_traits_checker_add_tests_impl)
    ...
    foreach(_test ${_test_list})
        # note: we could use a numeric index for shorter CLI output
        # note: CTest implements its own add_test() and set_tests_properties()
        # among other commands that aren't the same as the CMake versions
        string(
            APPEND _add_test_script
"add_test(\n"
"    \"${NPYGL_TC_TARGET_NAME}.${_test}\"\n"
"    \"${NPYGL_TC_DRIVER_PATH}\" -t \"${_test}\"\n"
")\n"
"set_tests_properties(\n"
"    \"${NPYGL_TC_TARGET_NAME}.${_test}\" PROPERTIES\n"
...
function(npygl_traits_checker_add_tests target)
    ...
    # indicate if multi-config
    get_property(multi_config GLOBAL PROPERTY GENERATOR_IS_MULTI_CONFIG)
    # master script generator expression
    set(
        _script_file_genex
        "${_script_prefix}-$<IF:${multi_config},$<CONFIG>,impl>.cmake"
    )
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND}
                ...
                -DNPYGL_TC_IMPL_SCRIPT=${_script_file_genex}
                -P ${PROJECT_SOURCE_DIR}/cmake/npygl_traits_checker_add_tests.cmake
        COMMENT "Collecting ${target} tests"
        VERBATIM
    )
