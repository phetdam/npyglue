 ...
 *
 * @note It is unclear why `traits_checker_driver<traits_checker<Traits, T>>`
 *  exists as this partial specialization can be implemented using the members
 *  of the `traits_checker<Traits, T>` specializations directly.
 *
